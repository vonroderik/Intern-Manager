from PySide6.QtWidgets import (
    ...
    QAbstractItemView, QMessageBox, QLabel, QFrame
)
...
class CriteriaManagerDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        icon_lbl = QLabel()
        icon_lbl.setPixmap(qta.icon('fa5s.tasks', color=COLORS['primary']).pixmap(QSize(32, 32)))
        ...
        lbl_sub = QLabel("Defina os pesos e critérios para calcular as notas dos estagiários.")
        ...
        self.table.setHorizontalHeaderLabels(["ID", "Critério", "Peso (Pts)", "Descrição"])
        ...
        btn_close.setStyleSheet(f"color: {COLORS['secondary']}; background: transparent; border: none;")
