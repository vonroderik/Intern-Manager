from PySide6.QtWidgets import (
    ...
    QPushButton, QLabel, QHeaderView, QHBoxLayout, QFileDialog, QMessageBox
)
...
class ReportDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.btn_pdf.setStyleSheet("background-color: #0078D7; color: white; font-weight: bold; padding: 10px;")
    ...
    def load_data(self):
        ...
        self.student_grades = self.grade_service.get_intern_grades(self.intern.intern_id)
    ...
    def export_pdf(self):
        ...
        if filename:
            try:
                ...
                QMessageBox.information(self, "Sucesso", f"Boletim salvo em:\n{filename}")
