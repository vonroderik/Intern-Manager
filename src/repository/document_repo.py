...
class DocumentRepository:
    ...
    def get_by_intern_id(self, intern_id: int) -> List[Document]:
        sql_query = "SELECT document_id, intern_id, document_name, is_completed FROM documents WHERE intern_id = ?"
    ...
    def get_by_id(self, document_id: int) -> Optional[Document]:
        sql_query = "SELECT document_id, intern_id, document_name, is_completed FROM documents WHERE document_id = ?"
    ...
    # --- NOVO MÉTODO: Conta pendências direto no SQL ---
    def count_pending(self) -> int:
        """Retorna o total de documentos com is_completed = 0 (False)."""
        sql_query = "SELECT COUNT(*) FROM documents WHERE is_completed = 0"
    ...
    def save(self, document: Document) -> int:
        ...
        sql_query = "INSERT INTO documents (intern_id, document_name, is_completed) VALUES (?, ?, ?)"
    ...
    def update(self, document: Document) -> bool:
        ...
        sql_query = "UPDATE documents SET document_name = ?, is_completed = ? WHERE document_id = ?"
